...
// Removido o import da AbaUsuarios conforme decisão anterior
  ...
  return (
    <AppLayout>
      ...
      <Tabs defaultValue="geral" className="flex flex-col md:flex-row gap-8">
        ...
        {/* ALTERAÇÃO: Wrapper adicionado para permitir rolagem horizontal das abas no mobile */}
        <div className="relative w-full overflow-x-auto md:w-60 md:overflow-x-visible">
          <TabsList className="flex-shrink-0 flex-row md:flex-col h-auto w-full md:w-60 justify-start p-1 bg-gray-100/80 rounded-lg">
            ...
            {/* O trigger para 'Usuários e Permissões' foi removido conforme decisão anterior */}
        ...
        <div className="flex-grow">
          ...
          {/* O conteúdo para 'Usuários e Permissões' foi removido conforme decisão anterior */}
