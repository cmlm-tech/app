...
export default function MembroMesaCard({ vereador, cargo }: Props) {
            ...
            {vereador ? (
                <>
                    <img
                        ...
                        alt={vereador.nome}
                        className="w-24 h-24 rounded-full object-cover border-4 border-gov-blue-100 mb-3 shadow-md"
                    />
                    <h3 className="text-lg font-bold text-gov-blue-900 text-center mb-1">
                        {vereador.nome}
                    </h3>
                ...
                <div className="flex flex-col items-center justify-center h-full text-gray-400">
                    <div className="w-24 h-24 rounded-full bg-gray-100 border-4 border-gray-200 mb-3 flex items-center justify-center">
